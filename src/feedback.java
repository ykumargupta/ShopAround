...
public class feedback extends HttpServlet {
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try{
            ...
            PreparedStatement ps1=con.prepareStatement("insert into feedback(f_id,cus_id,email_id,message,f_date,status) values(?,?,?,?,?,?)");
            ps1.setInt(1, j);
            ps1.setInt(2, cus_id);
        ...
        String date=dt+"-"+month+"-"+yr;
            ...
            res.sendRedirect("customer/feedback.jsp");
