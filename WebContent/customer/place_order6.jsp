...
<html>
    ...
    try{
       ...
       mypack.sendsms.user = "deepak";
       mypack.sendsms.password = "123456";
       mypack.sendsms.phonenumber = phone;
       mypack.sendsms.text = "*ShopAround-Hi "+name+"INR"+price+" Debited from your account.Thanks for using ShopAround!";
      System.out.println( mypack.sendsms.send());             
        ...
        <center>
           ...
           <% if(!rs.getString(4).equalsIgnoreCase("cash_on_delivery")){ %>
            <table width="840" border="0">
                <tr>
                    <td width="60"></td>
                    <td><p style=" font-size: 12px; color: #cc0000">* Shipped : Bluedart Couriers. Tracking ID: TRID21<%=rs.getString(5)%></p></td>
                </tr>
            </table>
            <% } %>
